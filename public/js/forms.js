            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (errorText === 'User already exists with this email address') {
                        displayError('register-error', 'User already exists with this email address');
                    } else if (errorText === 'User already exists with this username') {
                        displayError('register-error', 'User already exists with this username');
                    } else {
                        displayError('register-error', 'This account already exists. Please go to the login page.');
                    }
                }
            } catch (error) {
                console.error('Error:', error);
                displayError('register-error', 'An error occurred while trying to register. Please try again later.');
            }
        });
    }
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                console.error('Error:', error);
                displayError('login-error', 'An error occurred while trying to login. Please try again later.');
            }
        });
    }
});
